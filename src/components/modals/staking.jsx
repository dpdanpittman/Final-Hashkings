...
const StakingModal = props => {
    const getStat = stat => {
        return props.user !== undefined ? props.user.tokens[stat] : <i className="fa fa-circle-o-notch fa-spin text-danger"></i>;
    }
    ...
    const MotaModal = () => {
        return (
            <div className="submodal mota-submodal">
                <img onClick={ e => toggleSubModal('mota-submodal', true) } className="close-btn highlight-on-hover" src={ ClosePNG } />
                <div className="body">
                    <div>
                    ...
                    <div>
                        ...
                        <div className="value">
                            ...
                            <img onClick={ e => Farm.depositBuds(props.username, 'nothing has been set to state here yet')} className="highlight-on-hover deposit-buds" src={ DepositButton } />
                        </div>
                    </div>
            ...
            <div className="submodal stake-submodal">
                ...
                <div className="body">
                    ...
                    <div>
                        ...
                        <div className="value">
                            <input type="number" step="1" min="1" />
                            <img onClick={ e => Farm.stakeMota(props.username, 'nothing has been set to state here yet')} className="stake-btn highlight-on-hover" src={StakeButton} />
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="value">
                            <input type="number" step="1" max={user().tokens.mota.stake} />
                            <img onClick={ e => Farm.unstakeMota(props.username, 'nothing has been set to state here yet')}  className="stake-btn highlight-on-hover" src={UnstakeButton} />
                        </div>
    ...
    const renderTabs = () => {
        ...
        return tabs.map(tab => (
            <div onClick={ e => toggleSubModal(`${tab.link}`) } className={ tab.class }>
                <h4>{ tab.headline }</h4>
    ...
    return (
        <Modal centered dialogClassName="staking_modal" show={props.show} onHide={() => props.hideModal("staking")} size={props.size || 'lg'}>
